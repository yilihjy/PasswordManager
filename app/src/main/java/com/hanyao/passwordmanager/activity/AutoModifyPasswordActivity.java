...
public class AutoModifyPasswordActivity extends BaseActivity {
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(loginSiteTIL.getEditText().getText())) {
                    Toast.makeText(AutoModifyPasswordActivity.this, "登录网站或应用不能为空", Toast.LENGTH_SHORT).show();
                    return;
                } else if (TextUtils.isEmpty(loginUserNameTIL.getEditText().getText())) {
                    Toast.makeText(AutoModifyPasswordActivity.this, "登录名不能为空", Toast.LENGTH_SHORT).show();
                    return;
                } else {
    ...
    protected void onDestroy(){
        super.onDestroy();
        if(newPassword!=null){
            Intent intent =new Intent(AutoModifyPasswordActivity.this,DisplayPasswordActivity.class);
